...
public class Events<T extends Event> implements Listener, EventExecutor {
    ...
    public static <T extends Event> Events<T> subscribe(Class<T> clazz, EventPriority priority, boolean ignoreCancelled, Function<T, Boolean> func) {
        ...
        if (Bukkit.isPrimaryThread()) {
            Bukkit.getPluginManager().registerEvent(clazz, factory, priority, factory, Arathoth.INSTANCE.getPlugin(), ignoreCancelled);
        } else {
            Bukkit.getScheduler().runTask(Arathoth.INSTANCE.getPlugin(), () -> Bukkit.getPluginManager().registerEvent(clazz, factory, priority, factory, Arathoth.INSTANCE.getPlugin(), ignoreCancelled));
        }
        return factory;
    }
    ...
    public void unregister() {
        ...
        try {
            ...
            if (Bukkit.isPrimaryThread()) {
                ...
                Bukkit.getScheduler().runTask(Arathoth.INSTANCE.getPlugin(), () -> handlerList.unregister(this));
            }
